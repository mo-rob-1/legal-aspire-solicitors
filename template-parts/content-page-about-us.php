...
<section class="about-us-pg" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <!-- <div class="about-us-pg__container"> -->
        <div class="about-us-pg__item-one-wrapper">
            <div class="about-us-pg__col-1">
                <h5>Who We Are</h5>
                <h2>Your partner for legal</h2>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Odit magni accusamus sapiente in fugiat cum, tempore sunt aspernatur iure necessitatibus ab, 
            ...
            <div class="about-us-pg__col-2">
                <img class="experience__img" src="http://legal-aspire-solicitors.local/wp-content/uploads/2021/07/solicitors-coversation.jpg" alt="Image" />
            </div>
        </div>

        <div class="about-us-pg__item-two-wrapper">
            <div class="about-us-pg__item-two-col-1">
                <h3>01 Legal Advisors</h3>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perferendis aspernatur a consequuntur tenetur. 
                Necessitatibus aliquid totam in distinctio hic deserunt</p>
            </div>
            <div class="about-us-pg__item-two-col-2">
                <h3>02 Trusted Experience</h3>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perferendis aspernatur a consequuntur tenetur. 
                Necessitatibus aliquid totam in distinctio hic deserunt</p>
            </div>
            <div class="about-us-pg__item-two-col-3">
                <h3>03 Responsiveness</h3>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perferendis aspernatur a consequuntur tenetur. 
                Necessitatibus aliquid totam in distinctio hic deserunt</p>
            </div>
        </div>
        ...
        <div class="about-us-pg__filter" uk-filter="target: .js-filter">
            ...
            <ul class="js-filter uk-child-width-1-2 uk-child-width-1-3@m uk-text-center" uk-grid>
                <li data-color="white">
                    <div class="uk-card uk-card-default uk-card-body card-box-shadow-none">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</div>
                </li>
                <li data-color="blue">
                    <div class="uk-card uk-card-body card-box-shadow-none">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perferendis aspernatur a consequuntur tenetur. 
                    Necessitatibus aliquid totam in distinctio hic deserunt.</div>
                </li>
                <li data-color="black">
                    <div class="uk-card uk-card-default uk-card-body card-box-shadow-none">Ad nec admodum perfecto mnesarchum, vim ea mazim fierent detracto. Ea quis iuvaret expetendis his, te elit voluptua dignissim per, habeo iusto primis ea eam.</div>
                </li>
            </ul>
        </div>
